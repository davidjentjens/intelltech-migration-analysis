    ...
    <div className="space-y-6 max-w-7xl mx-auto" data-section="security">
            ...
            <thead>
              <tr className="border-b-2 border-gray-300">
                ...
                <th className="text-center font-semibold p-3">
                  GitLab EE
                  <br />
                  <span className="text-xs text-gray-500">(On-Premises)</span>
                </th>
                <th className="text-center font-semibold p-3">
                  GitHub ES
                  <br />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-gray-700">
              <li>
                • <strong>Lacunas de segurança e auditoria</strong>
              </li>
        ...
        <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-6">
          ...
          <div className="mb-4">
            ...
            <ul className="space-y-1 text-sm text-gray-700">
              <li>
                • <strong>Plataforma unificada</strong> (All-in-One)
              </li>
              <li>• Integração nativa SAST, DAST, etc</li>
              <li>
                • <strong>Governança centralizada</strong>
              </li>
              <li>• Compliance Frameworks nativos</li>
              <li>• Visibilidade completa</li>
              <li>
                • <strong>Evolução natural</strong> (baixo risco)
              </li>
            </ul>
          </div>
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
          ...
          <div className="mb-4">
            ...
            <ul className="space-y-1 text-sm text-gray-700">
              ...
              <li>
                • <strong>CodeQL SAST</strong> (reconhecido no mercado)
              </li>
              <li>
                • <strong>Push Protection</strong> (preventivo)
              </li>
          ...
          <div className="mb-4">
            ...
            <ul className="space-y-1 text-sm text-gray-700">
              <li>
                • <strong>Advanced Security como add-on</strong>
              </li>
              <li>• Ausência de DAST nativo</li>
              <li>• Foco menor em compliance</li>
              <li>
                • <strong>Projeto de migração</strong> complexo
              </li>
            </ul>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white border border-orange-300 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-700">
                  <strong>Evolução natural e baixo risco.</strong> Suíte DevSecOps unificada com
                  governança centralizada. Ideal para simplificação operacional e gestão integrada
                  de vulnerabilidades.
                </p>
              </div>
              <div className="bg-white border border-blue-300 rounded-lg p-4">
                <h4 className="font-bold text-blue-800 mb-2">
                  🎯 Cenário 2: GitHub ES + Advanced Security
                </h4>
                <p className="text-sm text-gray-700">
                  <strong>Migração complexa com excelência técnica.</strong> Acesso ao CodeQL (SAST
                  líder de mercado) e Push Protection, mas requer integração de soluções
                  complementares.
                </p>
              </div>
            </div>
            <div className="bg-white border border-gray-300 rounded-lg p-4">
              <p className="text-gray-800 text-sm">
                <strong>📋 Nota Importante:</strong> Para o GitHub Enterprise Server ser comparável
                ao GitLab EE em segurança, a contratação do complemento &quot;Advanced
                Security&quot; é <strong>indispensável</strong>. Sem ele, a plataforma não atende
                diversos critérios de segurança críticos.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-50 border border-gray-300 rounded-lg p-4">
        ...
        <p className="text-gray-700 text-sm">
          As opções <strong>GitHub Enterprise Cloud</strong> e <strong>GitLab Cloud</strong> não
          foram avaliadas nesta análise de Segurança da Informação, que se concentrou
          especificamente em soluções on-premises para atender aos requisitos de controle de dados
          da organização.
        </p>
      </div>
    </div>
