...
const costData = {
  ...
  github_ee_cloud_copilot: {
    licenseMensal: 11863.5, // ($21 × 47) + ($39 × 30) = $987 + $1170 = $2157 × 5,50 = R$ 11.863,50
    infrastructureMensal: 0,
    get totalMensal() {
      return this.licenseMensal + this.infrastructureMensal;
    },
  ...
  ia: {
    github: {
      tools: [
        ...
        'Sugestões para patterns modernos (async/await, DI)',
        'Integração com Azure services',
        'Resolução automática de vulnerabilidades',
        'Code review automatizado com análise de bugs',
        'Agente de código para delegação de tarefas',
        'Suporte a múltiplos modelos de IA (Claude, GPT, Gemini)',
        'Sugestões de próximas edições inteligentes',
        'Detecção e supressão de código duplicado',
        'Filtros avançados de segurança em tempo real',
        'Integração nativa com GitHub Actions e workflows',
        'Suporte completo a refatoração de código legado',
      ],
      rating: 9.5,
