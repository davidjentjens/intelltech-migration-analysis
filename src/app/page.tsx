...
const ComparisonPage: React.FC = () => {
  ...
  return (
    <>
      {/* Desktop Only Message - Shows on screens smaller than 1024px */}
      <DesktopOnlyMessage />

      {/* Main Application - Shows on screens 1024px and larger */}
      <div className="hidden lg:block min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
